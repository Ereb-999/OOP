public class Main {
    public static void main(String[] args) {
      ...
      bestStudent.bestStudentGryffindor(studentsGryffindor[2], studentsGryffindor[0]);
      bestStudent.bestStudentHufflepuff(studentsHufflepuff[1], studentsHufflepuff[0]);
      bestStudent.bestStudentRavenclaw(studentsRavenclaw[0], studentsRavenclaw[1]);
      bestStudent.bestStudentSlytherin(studentsSlytherin[2],  studentsSlytherin[1]);
